...
const ExampleInputDocumentation = ({ theme }: { theme: 'light' | 'dark' }) => {
  ...
  const copyToClipboard = async () => {
    try {
      await navigator.clipboard.writeText('https://github.com/patrickmast/pm7-ui-style-guide/blob/main/src/components/input/README.md');
      setCopied(true);
        ...
        <div style={{ 
          ...
          <div style={{ flex: '1', minWidth: '300px', position: 'relative' }}>
            <code style={{ 
              ...
              https://github.com/patrickmast/pm7-ui-style-guide/blob/main/src/components/input/README.md
            </code>
            <button
              onClick={() => window.open('https://github.com/patrickmast/pm7-ui-style-guide/blob/main/src/components/input/README.md', '_blank')}
              style={{
                position: 'absolute',
                right: '8px',
                top: '50%',
