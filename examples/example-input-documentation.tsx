...
const ExampleInputDocumentation = ({ theme }: { theme: 'light' | 'dark' }) => {
  const [copied, setCopied] = useState(false);
  
  const copyToClipboard = async () => {
    try {
      await navigator.clipboard.writeText('https://raw.githubusercontent.com/patrickmast/pm7-ui-style-guide/main/src/components/input/README.md');
      setCopied(true);
  ...
  return (
    <>
      <div style={{ paddingLeft: '0.5rem', paddingRight: '0.5rem', paddingBottom: '0.5rem' }}>
        <h3 style={{ fontSize: '1.25rem', fontWeight: '600', marginBottom: '1rem', color: theme === 'dark' ? '#ffffff' : '#000000' }}>PM7Input Component</h3>
        ...
        <div style={{ 
          ...
          <div style={{ flex: '1', minWidth: '300px', position: 'relative' }}>
            <code style={{ 
              ...
              https://raw.githubusercontent.com/patrickmast/pm7-ui-style-guide/main/src/components/input/README.md
            </code>
            <button
              onClick={() => window.open('https://raw.githubusercontent.com/patrickmast/pm7-ui-style-guide/main/src/components/input/README.md', '_blank')}
              style={{
                position: 'absolute',
                right: '8px',
                top: '50%',
      ...
      <div style={{ 
        ...
        <p style={{ 
          ...
          met alle essentiële PM7Input implementatie guidance.
        </p>
        <div style={{ 
          fontSize: '0.9rem',
...
export default ExampleInputDocumentation;