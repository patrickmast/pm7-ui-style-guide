...
const ExampleTabSelectorDocumentation = ({ theme }: { theme: 'light' | 'dark' }) => {
  ...
  const copyToClipboard = async () => {
    try {
      await navigator.clipboard.writeText('https://raw.githubusercontent.com/patrickmast/pm7-ui-style-guide/main/src/components/tab-selector/README.md');
      setCopied(true);
        ...
        <div style={{ 
          ...
          <div style={{ flex: '1', minWidth: '300px', position: 'relative' }}>
            <code style={{ 
              ...
              https://raw.githubusercontent.com/patrickmast/pm7-ui-style-guide/main/src/components/tab-selector/README.md
            </code>
            <button
              onClick={() => window.open('https://raw.githubusercontent.com/patrickmast/pm7-ui-style-guide/main/src/components/tab-selector/README.md', '_blank')}
              style={{
                position: 'absolute',
                right: '8px',
                top: '50%',
