...
const ExampleThemeToggleDocumentation = ({ theme }: { theme: 'light' | 'dark' }) => {
  const [copied, setCopied] = useState(false);
  
  const copyToClipboard = async () => {
    try {
      await navigator.clipboard.writeText('https://github.com/patrickmast/pm7-ui-style-guide/blob/main/src/components/theme-toggle/README.md');
      setCopied(true);
  ...
  return (
    <>
      <h3 className="text-xl font-semibold mb-3">PM7ThemeToggle Component Documentation</h3>
        ...
        <div style={{ 
          ...
          <div style={{ flex: '1', minWidth: '300px', position: 'relative' }}>
            <code style={{ 
              ...
              https://github.com/patrickmast/pm7-ui-style-guide/blob/main/src/components/theme-toggle/README.md
            </code>
            <button
              onClick={() => window.open('https://github.com/patrickmast/pm7-ui-style-guide/blob/main/src/components/theme-toggle/README.md', '_blank')}
              style={{
                position: 'absolute',
                right: '8px',
                top: '50%',
      ...
      <div style={{ 
        ...
        <p style={{ 
          ...
          met alle essentiële PM7ThemeToggle implementatie guidance.
        </p>
        <div style={{ 
          fontSize: '0.9rem',
...
export default ExampleThemeToggleDocumentation;